...
/// A asynchronous driver for the SGP4x device.
    ...
    Duration: From<Command<V>>,
{
    ...
    pub async fn self_test(&mut self) -> Result<TestResult, Error<I2C::Error>> {
    ...
    pub async fn serial_number_fetch(&mut self) -> Result<u64, Error<I2C::Error>> {
...
mod tests {
    ...
    fn test_heater_disable() {
        ...
        create_i2c::<Sgp40, _>(&expectations, async |mut device| {
    ...
    fn test_sgp41_measure_raw_signals() {
        ...
        create_i2c::<Sgp41, _>(&expectations, async |mut device| {
            assert_matches!(
                device.measure_raw_signals().await,
    ...
    fn test_into_variant() {
        ...
        create_i2c::<Sgp41, _>(&expectations, async |mut device| {
            ...
            assert_matches!(
                new_device.measure_raw_signals().await,
                Ok(RawMeasurement::Partial { voc: 44 })
            );
        });
    }
